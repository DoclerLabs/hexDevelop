...
using ExpressionExplorer.Resources;
...
namespace ExpressionExplorer
{
    ...
    {
        private String pluginName = "Json TreeView";
        private String pluginGuid = "42ac7fab-421b-1f38-a985-72a03534f731";
        private String pluginHelp = "www.flashdevelop.org/community/";
        private String pluginDesc = "A plugin to get a treeview from expressions in Haxe";
        ...
        public void HandleEvent(Object sender, NotifyEvent e, HandlingPriority prority)
        {
            switch (e.Type)
            {
                case EventType.Trace:
                    ...
                    //MessageBox.Show("trace :->  " + log[log.Count - 1].Message);
                    pluginUI.treeGeneration(log[log.Count - 1].Message);
                    break;
        ...
        {
            String dataPath = Path.Combine(PathHelper.DataDir, "Json TreeView");
        ...
        public void AddEventHandlers()
        {
            ...
            EventManager.AddEventHandler(this, EventType.FileSwitch | EventType.Command | EventType.Trace);
        }
